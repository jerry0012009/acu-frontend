...
type UserSetting struct {
	...
	AdvisorNotificationInAppEnabled   *bool    `json:"advisor_notification_in_app_enabled,omitempty"`
	AdvisorNotificationBrowserEnabled *bool    `json:"advisor_notification_browser_enabled,omitempty"`
	AdvisorNotificationEmailEnabled   *bool    `json:"advisor_notification_email_enabled,omitempty"`
	AdvisorNotificationEmail          string   `json:"advisor_notification_email,omitempty"`
}
