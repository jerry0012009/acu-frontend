...
func InitOptionMap() {
	...
	common.OptionMap["ACUGlobalRoutingPolicy"] = `{"modelPolicy":"all_routing_eligible","allowedModelIds":[],"profilePolicy":"all_routing_eligible","allowedProfileIds":[]}`
	common.OptionMap["ACURoutingUtilityConfig"] = `{"schemaVersion":"acu-routing-utility-config-v1","formulaMode":"legacy","qualityPresets":{"economy":-60,"balanced":0,"quality":60},"acuHighBiasOffset":40,"modelCostLogScale":2.5,"supplyPresets":{"lowest_cost":{"cost":100,"speed":0,"reliability":0},"balanced":{"cost":40,"speed":25,"reliability":35},"low_latency":{"cost":10,"speed":80,"reliability":10},"high_reliability":{"cost":10,"speed":10,"reliability":80}},"profileCostLogScale":2.5,"profileSpeedLogScale":2.5,"latency":{"windowHours":24,"longContextThresholdTokens":100000,"minimumSamples":5,"unknownLatencyMultiplier":1.2},"reliability":{"windowHours":24,"minimumSamples":5,"unknownDefault":0.75,"degradedMultiplier":0.85},"workPhaseBiasOffsets":{"inspection":-10,"general":0,"implementation":0,"verification":0,"planning":10,"recovery":20}}`
