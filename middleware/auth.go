...
func SetupContextForToken(c *gin.Context, token *model.Token, parts ...string) error {
	...
	c.Set("acu_allowed_candidate_ids", token.ACUAllowedCandidateIDs)
	c.Set("acu_candidate_preference_scores", token.ACUCandidatePreferenceScores)
	c.Set("acu_profile_preference_scores", token.ACUProfilePreferenceScores)
	...
	c.Set("acu_profile_limit_enabled", token.ACUProfileLimitsEnabled)
	c.Set("acu_profile_limits", append([]string(nil), token.ACUProfileLimits...))
