	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/self/acu-advisor/notifications", middleware.DisableCache(), controller.GetPrivateACUAdvisorNotifications)
				selfRoute.POST("/self/acu-advisor/notifications/read-all", middleware.DisableCache(), controller.MarkAllPrivateACUAdvisorNotificationsRead)
				selfRoute.POST("/self/acu-advisor/:advisor_id/read", middleware.DisableCache(), controller.MarkPrivateACUAdvisorNotificationRead)
				selfRoute.GET("/self/acu-advisor/notification-preferences", middleware.DisableCache(), controller.GetPrivateACUAdvisorNotificationPreferences)
				selfRoute.PUT("/self/acu-advisor/notification-preferences", middleware.DisableCache(), controller.UpdatePrivateACUAdvisorNotificationPreferences)
				selfRoute.GET("/self/acu-memory", middleware.DisableCache(), controller.GetPrivateACUMemoryForUser)
				selfRoute.GET("/self/acu-film", middleware.DisableCache(), controller.GetPrivateACUFilmForUser)
		...
		privateACUAdminRoute := apiRouter.Group("/admin/acu-private")
		{
			...
			privateACUAdminRoute.GET("/film", middleware.AdminAuth(), controller.GetPrivateACUFilmStatus)
			privateACUAdminRoute.GET("/access", middleware.AdminAuth(), controller.GetPrivateACUPOCAccess)
			privateACUAdminRoute.PUT("/access", middleware.RootAuth(), controller.SavePrivateACUPOCAccess)
			privateACUAdminRoute.GET("/experiences", middleware.AdminAuth(), controller.GetPrivateACUExperiences)
			privateACUAdminRoute.GET("/experiences/:experienceId", middleware.AdminAuth(), controller.GetPrivateACUExperienceDetail)
			privateACUAdminRoute.GET("/learning-runs", middleware.AdminAuth(), controller.GetPrivateACULearningRuns)
			privateACUAdminRoute.GET("/learning-runs/:runId", middleware.AdminAuth(), controller.GetPrivateACULearningRunDetail)
			privateACUAdminRoute.GET("/learning-runs/:runId/media/:mediaId", middleware.AdminAuth(), controller.GetPrivateACULearningRunMedia)
			privateACUAdminRoute.GET("/usage", middleware.AdminAuth(), controller.GetPrivateACUUsage)
			privateACUAdminRoute.GET("/advisors", middleware.AdminAuth(), controller.GetPrivateACUAdvisorsByUserID)
		...
		executionProfileRoute.Use(middleware.RootAuth(), middleware.DisableCache())
		{
			...
			executionProfileRoute.PATCH("/channels/:id", controller.UpdateACUChannelConnection)
			executionProfileRoute.PATCH("/:id/calibration", controller.ReconcileACUExecutionProfileCalibration)
