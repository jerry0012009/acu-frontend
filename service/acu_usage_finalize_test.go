...
func TestFinalizeACUUsageChargesAndUpdatesLogExactlyOnce(t *testing.T) {
	...
	require.NotContains(t, publicBreakdown, "actual_total_cash_cost_cny")
	require.NotContains(t, publicBreakdown, "retail_markup_multiplier")
	require.NotContains(t, publicBreakdown, "billing_source")
	require.NotContains(t, publicBreakdown, "billing_note")
